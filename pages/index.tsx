        ...
        <section className="mb-16 md:mb-12">
          <div className="text-center lg:px-32">
            ...
            <div className="block xs:h-60 sm:h-80">
              <p className="absolute left-0 right-0 m-auto mt-5 xs:mt-9 font-custom xs:text-13xl text-8xl transform -rotate-8">
                Nicholas Monaco
              </p>
              <p className="absolute left-0 right-0 m-auto xs:mt-32 mt-40 font-custom xs:text-13xl text-8xl transform -rotate-8">
                Delaney Higgins
              </p>
              <p className="my-0 text-white text-11xl xs:text-14xl">&</p>
            </div>
